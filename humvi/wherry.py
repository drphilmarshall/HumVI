...
Wherry et al iteration on the Lupton et al asinh stretch color image algorithm

Translated from IDLutils by Cato Sandford, Autumn 2012.

Notes:

* Works as a standalone module, or integrated into HumVI
  This means there's some extra baggage.
* If an argument variable doesn't have the correct type, e.g. expects list 
  but gets None, the relevant steps of the code are skipped.
